    ...
    <AdminLayout title="Dashboard">
        ...
        >
            ...
            <a-form-item label="Display Number" name="number_display">
                <a-input v-model:value="modal.data.number_display" :disabled="modal.mode=='EDIT'"  />
            </a-form-item>
            ...
            <a-form-item label="Avata" name="avata">
                <div v-if="modal.data.media.length" >
                    <inertia-link :href="route('admin.certificate-delete-media',modal.data.media[0].id)" class="float-right text-red-500">
    ...
    methods: {
        ...
        updateRecord(){
            this.$refs.modalRef.validateFields().then(()=>{
                ...
                this.$inertia.post(route('admin.certificates.update', this.modal.data.id), this.modal.data,{
                    onSuccess:(page)=>{
                        this.modal.isOpen=false;
                    },
                    onError:(error)=>{
