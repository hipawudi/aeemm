...
<template>
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        <div v-if="canLogin" class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            <Link v-if="$page.props.user" :href="route('dashboard')" class="text-sm text-gray-700 dark:text-gray-500 underline">會員專區</Link>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="https://laravel.com/docs" class="underline text-gray-900 dark:text-white">學會宗旨</a>
                            </div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <ol style="padding-left:15px;text-indent:-15px">
                                    <li>1. 加強本澳電機及機械工程專業人士的聯繫溝通及技術交流，並深化與本地及外地同類型組織的聯繫及合作藉以交流訊息及分享經驗，以提升本澳電機及機械工程的專業技術水平。</li>
                                    <li>2. 加強會員們的團結及提高會員之專業技術水平，培訓本澳電機及機械工程人才，以推動電機及機械行業之發展。</li>
                                    <li>3. 推廣電機及機械工程的普及教育及進行電機及械機工程之專業研究，以電機及機械專業技術服務社會及推動社會發展。</li>
                                    <li>4. 加強與政府部門、社團及相關機構的合作交流，以提升電機及機械工程的專業地位。</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="https://laracasts.com" class="underline text-gray-900 dark:text-white">加入澳門機電工程師學會</a>
                            </div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                歡迎加入唯一在澳門機電工程技術範疇的專業學會，有了你們的加入，更可使本會在機電工程技術領域開拓更多的發展策略，並繼續履行所要肩負的宗旨及目標，共同為會員及業界推展澳門機電工程技術。我們深信在會員們的不懈努力下，機電工程專業方面在本地區將獲得更多的認受性及持續發展，並能與國際性的工程專業學會接軌，從而使會員們更易取得國際性認可的專業資格。
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="https://laravel-news.com/" class="underline text-gray-900 dark:text-white">學會介紹</a>
                            </div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                本會融合在澳門特區政府內工程技術部門、專上學院、公用及專營企業、執業顧問事務所及營造承建企業從事電機及機械工程專業的工程師、承建商及工程技術人員所組成。透過政府機構、學術研究及業界的互動，本會希望建立一個提供本澳電機及機械工程人員進行提升專業技能及競爭能力的平臺。                                
                            </div>
                        </div>
                    </div>
